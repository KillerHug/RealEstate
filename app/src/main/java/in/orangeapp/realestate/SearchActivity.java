...
public class SearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BannerAds.showBannerAds(SearchActivity.this, adLayout);
        ...
        JsonObject jsObj = (JsonObject) new Gson().toJsonTree(new API(SearchActivity.this));
        jsObj.addProperty("method_name", "properties_search");
        jsObj.addProperty("type_id", typeId);
        jsObj.addProperty("purpose", typePurpose);
        jsObj.addProperty("search_text", Search.replace(" ", "%20"));

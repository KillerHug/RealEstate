...
public class ProfileEditActivity extends AppCompatActivity implements Validator.ValidationListener {
    ...
    MyApplication MyApp;
    String strName, strEmail, strPassword, strMobile, strMessage, saveType, saveAId, strAdd;
    JsonUtils jsonUtils;
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        JsonObject jsObj = (JsonObject) new Gson().toJsonTree(new API(ProfileEditActivity.this));
    ...
    public void onValidationSucceeded() {
        ...
        if (JsonUtils.isNetworkAvailable(ProfileEditActivity.this)) {
            ...
            strAdd = edtAddress.getText().toString();
            ...
            jsObj.addProperty("address", strAdd);
            if (JsonUtils.isNetworkAvailable(ProfileEditActivity.this)) {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        if (objJson.has("status")) {
                            ...
                            edtAddress.setText(objJson.getString("address"));
                        }
                    }

...
import in.orangeapp.realestate.PropertyDetailsActivity;
...
public class PopUpAds {
        ...
        if (Constant.SAVE_ADS_FULL_ON_OFF.equals("true")) {
            if (Constant.SAVE_FULL_TYPE.equals("admob")) {
                        ...
                        public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                            ...
                            interstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                                ...
                                public void onAdDismissedFullScreenContent() {
                                    ...
                                    Intent intent_single = new Intent(context, PropertyDetailsActivity.class);
                ...
                if (Constant.AD_COUNT == Integer.parseInt(Constant.SAVE_ADS_CLICK)) {
                    Constant.AD_COUNT = 0;
                    Loading(context);
                    final com.facebook.ads.InterstitialAd mInterstitialfb = new com.facebook.ads.InterstitialAd(context, Constant.SAVE_ADS_FULL_ID);
    ...
    public static void Loading(Context context) {
        ...
        pDialog.setMessage(context.getResources().getString(R.string.loading_title));

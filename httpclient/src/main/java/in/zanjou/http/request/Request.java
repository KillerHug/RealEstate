package in.zanjou.http.request;
...
import in.zanjou.http.common.Header;
import in.zanjou.http.common.HeaderBag;
import in.zanjou.http.debug.Logger;
import in.zanjou.http.response.FileDownloadListener;
import in.zanjou.http.response.FileResponseListener;
import in.zanjou.http.response.ResponseListener;
import in.zanjou.http.util.ByteStream;
...
public class Request {
    ...
    public Request addParameter(String key, ArrayList<Image> images) {
